...
$output .= '<div class="usof-button type_change"><span>' . us_translate_with_external_domain( 'Change' ) . '</span></div>';
$output .= '<div class="usof-button type_remove"><span>' . us_translate_with_external_domain( 'Remove' ) . '</span></div>';
$output .= '</div>';
$output .= '</div>';
$output .= '</div>';
